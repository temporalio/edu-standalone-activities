...
- id: hvzxgvjkgch5
  ...
  type: code
  hostname: workshop
  path: /root/workshop/exercises/03-concurrency-and-rate-limits/exercise/src/webhooks
- id: 4tfuoxsgkh61
  title: Solution
  type: code
  hostname: workshop
  path: /root/workshop/exercises/03-concurrency-and-rate-limits/solution/src/webhooks
- id: uye7c8clfvle
  title: Terminal
  type: terminal
  hostname: workshop
