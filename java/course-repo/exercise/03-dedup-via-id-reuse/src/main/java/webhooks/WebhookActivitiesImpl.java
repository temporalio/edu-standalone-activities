    ...
    try {
      ...
      HttpRequest request =
          HttpRequest.newBuilder()
              ...
              // Receiver-side idempotency key from Module 02, still in place here.
      ...
      // Tiny pause so the second duplicate start lands while this Activity is
      // still in flight (idConflictPolicy applies; idReusePolicy does not).
      Thread.sleep(1000);
